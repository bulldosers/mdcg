...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	*/
	...
	<div id="fh5co-page">
			...
			<div class="container">
				<nav role="navigation">
					<ul class="pull-left left-menu">
						<li><a href="index.jsp">H I T</a></li>
						<li><a href="index.jsp">R & D</a></li>
						<li><a href="index.jsp">G R O U P</a></li>
					</ul>
					<h1 id="fh5co-logo"><a href="index.html"><span></span></a></h1>
					<ul class="pull-right right-menu">
						<li><a href="login.jsp">Login</a></li>
						<li class="fh5co-cta-btn"><a href="register.jsp">Sign up</a></li>
					</ul>
				</nav>
			</div>
		</section>
		...
		<section id="fh5co-hero" class="js-fullheight" style="background-image: url(images/full_image_2.jpg);" data-next="yes">
				...
				<div class="fh5co-intro js-fullheight">
					<div class="fh5co-intro-text">
						...
						<div class="fh5co-left-position">
							<h2 class="animate-box">An Outsourcing Platform Based On Cloud Technology</h2>
							<p class="animate-box"><a href="weibo.jsp" class="btn btn-outline popup-vimeo btn-video"><i class="icon-play2"></i> Contact us</a> <a href="http://today.hit.edu.cn/" target="_blank" class="btn btn-primary">Follow us</a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-6 col-xxs-12 animate-box">
						<a href="images/im4.jpg" class="fh5co-project-item image-popup">
							<img src="images/im4.jpg" alt="Image" class="img-responsive">
							<div class="fh5co-text">
								<h2>Website Develop</h2>
								<p>You can release tasks or receive them if you need..</p>
							</div>
						</a>
					</div>

					<div class="col-md-4 col-sm-6 col-xxs-12 animate-box">
						<a href="images/im2.jpg" class="fh5co-project-item image-popup">
							<img src="images/im2.jpg" alt="Image" class="img-responsive">
							<div class="fh5co-text">
								<h2>Mobile App</h2>
								<p>You can release tasks or receive them if you need..</p>
							</div>
					...
					<div class="col-md-4 col-sm-6 col-xxs-12 animate-box">
						<a href="images/im7.jpg" class="fh5co-project-item image-popup">
							<img src="images/im7.jpg" alt="Image" class="img-responsive">
							<div class="fh5co-text">
					...
					<div class="col-md-4 col-sm-6 col-xxs-12 animate-box">
						<a href="images/im6.jpg" class="fh5co-project-item image-popup">
							<img src="images/im6.jpg" alt="Image" class="img-responsive">
							<div class="fh5co-text">
								<h2>UI Design</h2>
								<p>You can release tasks or receive them if you need..</p>
							</div>
					...
					<div class="col-md-4 col-sm-6 col-xxs-12 animate-box">
						<a href="images/im8.jpg" class="fh5co-project-item image-popup">
							<img src="images/im8.jpg" alt="Image" class="img-responsive">
							<div class="fh5co-text">
								<h2>Games</h2>
								<p>You can release tasks or receive them if you need..</p>
							</div>
			...
			<div class="container">
				<div class="row text-center row-bottom-padded-md">
					<div class="col-md-8 col-md-offset-2">
						...
						<h2 class="fh5co-lead animate-box">Perfect Work in All Devices</h2>
						<p class="fh5co-sub-lead animate-box">Hope to recruit a talented person? You can do it here.</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 col-sm-6 col-xs-12 animate-box">
						<div class="fh5co-feature">
							...
							<p>Any kind of work related to software can be find here..</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-6 col-xs-12 animate-box">
						<div class="fh5co-feature">
				...
				<div class="col-md-6 col-md-pull-6">
					...
					<div class="fh5co-feature">
						...
						<div class="fh5co-text animate-box">
							<h3>Nice Work</h3>
							<p>The quantity of work can be protected on our platform..</p>
						</div>
					</div>
					<div class="fh5co-feature">
						<div class="fh5co-icon animate-box"><i class="icon-check2"></i></div>
						<div class="fh5co-text animate-box">
							<h3>Negotiable Price</h3>
							<p>You may just need to pay a really low price to get a successful project..</p>
						</div>
					</div>
					<div class="fh5co-feature">
						<div class="fh5co-icon animate-box"><i class="icon-check2"></i></div>
						<div class="fh5co-text animate-box">
							<h3>Robust In Mind</h3>
							<p>Lots of amazing ideas are waiting for you..</p>
						</div>
					</div>
			...
			<div class="container">
				<div class="row row-bottom-padded-sm">
					<div class="col-md-6 col-md-offset-3 text-center">
						...
						<h2 class="fh5co-lead animate-box">Join the Users on Our Platform </h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						<div class="flexslider">
					  		<ul class="slides">
							   <li>
							      <blockquote>
							      	<p>&ldquo;They are really great !&rdquo;</p>
							      	<p><cite>&mdash; Wanzeng Fu</cite></p>
							      </blockquote>
							   </li>
							   <li>
							    	<blockquote>
							      	<p>&ldquo;I think design would be better .&rdquo;</p>
							      	<p><cite>&mdash; Shuijie Wang</cite></p>
							      </blockquote>
							   </li>
							   <li>
							    	<blockquote>
							      	<p>&ldquo;Design must be functional .&rdquo;</p>
							      	<p><cite>&mdash; Zixiao Ma</cite></p>
							      </blockquote>
							   </li>
							</ul>
						</div>
		...
		<footer id="fh5co-footer">
				...
				<div class="row row-bottom-padded-md">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 animate-box">
						<div class="fh5co-footer-widget">
							<h3>Contact Us</h3>
							<p>
								<a href="mailto:info@freehtml5.co">info@ MDCG</a> <br>
								92 Xidazhi Street, <br>
								 HIT, Harbin, Heilongjiang <br>
								<a href="tel:+15636835096">+156xxxx5096</a>
							</p>
						</div>
					</div>
			...
			<div class="fh5co-copyright animate-box">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<p class="fh5co-left"><small>&copy; 2016 <a href="index.html">MDCG</a> from HIT. All Rights Reserved.</small></p>
						</div>
					</div>
				</div>
			</div>
