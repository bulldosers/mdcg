		...
		<div id="content">
			...
			<div id="inputForm">
				...
				<s:form theme="simple" action="updateInfo.action" id="Information">
					...
					<s:textfield name="user.info.name" readonly="true" />
					<s:fielderror>
					...
					<s:textfield name="user.info.sex" readonly="true" />
					<s:fielderror>
					...
					<s:textfield name="user.info.age" readonly="true" />
					<s:fielderror>
					...
					<s:textfield name="user.info.major" readonly="true" />
					<s:fielderror>
					...
					<s:textfield name="user.info.school" readonly="true" />
					<s:fielderror>
					...
					<s:textfield name="user.info.phone" readonly="true" />
					<s:fielderror>
