		...
		<section id="fh5co-hero" class="no-js-fullheight" style="background-image: url(images/full_image_1.jpg);" data-next="yes">
				...
				<div class="fh5co-intro no-js-fullheight">
					<div class="fh5co-intro-text">
						...
						<div class="fh5co-center-position">
							<h2 class="animate-box">Login Now</h2>
							<h3 class="animate-box">To Find Thinkers, Innovators, Scientists, etc.</h3>
			...
			<div class="fh5co-learn-more animate-box">
				<a href="#" class="scroll-btn">
					<span class="text">Click on Here to Login</span>
			...
			<div class="container">
				<div class="row row-bottom-padded-sm">
					<div class="col-md-6 col-md-offset-3 text-center">
						<div class="fh5co-label animate-box">Join the Users on Our Platform</div>
						<h2 class="fh5co-lead animate-box">Login</h2>
					</div>
				</div> 
				<div class="row" style="color:black; text-align:center;">
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						<div class="flexslider" style="color:black; text-align:center;">
							<s:form action="login.action" method="post" cssStyle="color:black; text-align:center; label:black;">
      						<table>
      						<tr><td>username:</td></tr>
      						<tr style="color:black; text-align:center;"><s:textfield class="tre" name="user.username" label="- - - - - - - - - - - - - - - - - - - - - - - - - - - -username" cssStyle="width:200px; text-align:center;"></s:textfield><tr>
      						<tr><td>password:</td></tr>
      						<tr style="color:black; text-align:center;"><s:password class="tre" name="user.password" label="- - - - - - - - - - - - - - - - - - - - - - - - - - - -password" cssStyle="width:200px; text-align:center;"></s:password><tr>
      						<tr><td>verification:</td></tr>
      						<tr style="color:black; text-align:center;"><td><s:textfield class="tre" name="user.check" label="- - - - - - - - - - - - - - - - - - - - - - - - - -verification" cssStyle="width:200px; text-align:center;"></s:textfield></td>
      						<td><img src="rand.action" onclick="changeValidateCode(this)" /><br /><br /></td></tr>
      						<tr><td></td></tr>
      						<s:submit class="btn btn-primary" value="L O G I N" style="margin-left:50%;"></s:submit>
      						</table>
     			            </s:form>
						</div>
