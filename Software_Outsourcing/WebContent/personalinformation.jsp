		...
		<div id="content">
			...
			<div id="inputForm">
				...
				<s:form theme="simple" action="#" id="Information">
					...
					<s:fielderror>
						<s:param>person.name</s:param>
					</s:fielderror>
					<br />
					<br />

					<label class="Info" for="sex">性别</label>
					<s:textfield name="person.sex" />
					<s:fielderror>
						<s:param>person.sex</s:param>
					</s:fielderror>
					<br />
					<br />
					...
					<s:fielderror>
						<s:param>person.age</s:param>
					</s:fielderror>
					<br />
					<br />

					<label class="Info" for="age">专业</label>
					<s:textfield name="person.clg" />
					<s:fielderror>
						<s:param>person.clg</s:param>
					</s:fielderror>
					<br />
					<br />
					...
					<s:textfield name="person.school" />
					<s:fielderror>
						<s:param>person.school</s:param>
					</s:fielderror>
					<br />
					<br />
					...
					<s:textfield name="person.contact" />
					<s:fielderror>
						<s:param>person.contact</s:param>
					</s:fielderror>
					<br />
					<br />
					...
					<s:textarea name="person.school" id="ttt" Columns="50" TextMode="MultiLine"/>
					<s:fielderror>
						<s:param>person.school</s:param>
					</s:fielderror>
					<br />
