		...
		<section id="fh5co-hero" class="no-js-fullheight" style="background-image: url(images/hero_bg.jpg);" data-next="yes">
				...
				<div class="fh5co-intro no-js-fullheight">
					<div class="fh5co-intro-text">
						...
						<div class="fh5co-center-position">
							<h2 class="animate-box">Register Now</h2>
							<h3 class="animate-box">To Join Our Platform and Enjoy Yourself.</h3>
			...
			<div class="fh5co-learn-more animate-box">
				<a href="#" class="scroll-btn">
					<span class="text">Click on Here to Register</span>
			...
			<div class="container">
				<div class="row row-bottom-padded-sm">
					<div class="col-md-6 col-md-offset-3 text-center">
						...
						<h2 class="fh5co-lead animate-box">Sign up</h2>
					</div>
				</div> 
				<div class="row" style="color:black; text-align:center;">
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						<div class="flexslider" style="color:black; text-align:center;">
							<s:form action="register.action" method="post" cssStyle="color:black; text-align:center; label:black;">
      						<table>
      						...
      						<tr><td><br /><br /></td></tr>
      						<s:submit class="btn btn-primary" value="S i g n - u p" style="margin-left:50%;"></s:submit>
      						</table>
     			            </s:form>
						</div>
